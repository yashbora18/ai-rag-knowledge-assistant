...
def process_document_background(
    ...
    Process document text extraction and embeddings in the background.

    A separate database session is used because the request-scoped

    session must not be reused after the HTTP response is returned.
...
async def create_document(
    ...
    try:
        ...
        # ----------------------------------------------------
        # Text extraction and embedding generation are intentionally
        # moved to the existing background processor so the upload
        # request can return before Render's request timeout.
        document = Document(
        ...
        # ----------------------------------------------------
        # Process text extraction + chunks + embeddings
